...
Then test demo redirect:

```text
https://api.your-domain.com/api/demo?ref=dGVzdEBleGFtcGxlLmNvbQ%3D%3D
```

Expected behavior:

```text
HTTP 302 -> FRONTEND_BASE_URL/contactus/#send-message-section
```
...
-> BACKEND_BASE_URL/api/demo?ref=<encoded-email>
...
- Confirm the Book a Demo button URL starts with `BACKEND_BASE_URL/api/demo`.
- Click it and confirm the Contact Us page opens.
